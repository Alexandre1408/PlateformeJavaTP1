    ...
    <body>
        <form method="post" action="inscription">
            <fieldset>
                ...
                <label for="name">Nom de l'étudiant<span class="requis"> </span></label>
                <input type="text" id="name" name="name" value="<c:out value="${utilisateur.username}"/>" size="20" maxlength="20" />
